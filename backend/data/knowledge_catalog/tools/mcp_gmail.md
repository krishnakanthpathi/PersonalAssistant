...
tags: [gmail, create, draft, delete, get, list, drafts, send, label, labels, patch, update, batch, messages, modify, message, trash, untrash, attachment, thread, threads, auto, forwarding, imap, language, pop, vacation, add, delegate, remove, delegates, filter, filters, address, addresses, verify, smime, info, insert, set, default, profile, watch, mailbox, stop, mail, email, emails, inbox]
...
timestamp: 2026-08-04T16:58:19.368Z
---
